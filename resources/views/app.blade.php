...
@endphp
<html lang="en" dir="rtl" ng-app="angular">
...
<head>
  ...
  <link rel="stylesheet" href="{{asset('css/style.css')}}?fixcache=1">
  ...
  <div class="wrapper">
    ...
    <nav id="sidebar">
      <div class="sidebar-header">
        ...
        <a href="@route('home')">
          <h3><img src="{{asset('img/logo.png')}}" width="150px"></h3>
        </a>
    ...
    padding-left: 15px" id="sidebarCollapse2">
        ...
        <div class="input-group">
          ...
          color: white;"></i>
          <input  ng-model-options="{debounce: 500}" ng-change="search()" ng-model="value" type="text" class="form-control" id="searchbar" placeholder="بحث عن فلم او مسلسلة"
        ...
        <div ng-show="list.length > 0" class="dropdown-menu stay-open">
          
          <h5 style="float: right;" ng-show="list.length > 0"  class="dropdown-header">الافلام</h5>

          <a ng-repeat="da in list" class="dropdown-item"  href="{{URL::to('movies')}}/@{{da.id}}">
            <img src="@{{da.poster}}" width="30px">
            @{{da.name}}
          </a>

          <h5 style="float: right;" ng-show="listseries.length > 0"  class="dropdown-header">المسلسلات</h5>

          <a ng-repeat="da in listseries" class="dropdown-item" href="{{URL::to('series')}}/@{{da.id}}">
            <img src="@{{da.poster}}" width="30px">
            @{{da.name}}
          </a>
    ...
    angular.module('angular', [])
      .controller('searchctrl', function ($scope,$http) {
        ...
        $scope.search = function () {
          $http({
            method: 'GET',
            url: '{{URL::to("api/search")}}/' + $scope.value
          }).then(function successCallback(response) {
            $scope.list = response.data.movies
            $scope.listseries = response.data.series
